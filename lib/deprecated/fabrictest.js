            ...
            if (movedAss != targetAss) {
                for (const targetPiece of targetAss.getObjects()) {
                    for (const hotspot of targetPiece.hotspots) {
                        ...
                        let movedPieceAbsLeft = movedAss.left + movedPiece.getLeft() + movedAss.width / 2;
                        let movedPieceAbsTop = movedAss.top + movedPiece.getTop() + movedAss.height / 2;
                        let targetPieceAbsLeft = targetAss.left + targetPiece.getLeft() + targetAss.width / 2;
                        let targetPieceAbsTop = targetAss.left + targetPiece.getTop() + targetAss.height / 2;
